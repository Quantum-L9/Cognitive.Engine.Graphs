...
RULES = [
    ...
    {
        "id": "DI-001",
        "contract": "DEPENDENCY_INJECTION.md",
        "severity": "HIGH",
    ...
    {
        "id": "DEL-001",
        "contract": "DELEGATION_PROTOCOL.md",
        "severity": "CRITICAL",
    ...
    {
        "id": "MEM-001",
        "contract": "MEMORY_SUBSTRATE_ACCESS.md",
        "severity": "CRITICAL",
    ...
    {
        "id": "NAME-001",
        "contract": "PYDANTIC_YAML_MAPPING.md",
        "severity": "HIGH",
    ...
    {
        "id": "STUB-001",
        "contract": "ZERO_STUB_BUILD_PROTOCOL.md",
        "severity": "CRITICAL",
    ...
    {
        "id": "PKT-001",
        "contract": "PACKET_TYPE_REGISTRY.md",
        "severity": "HIGH",
